...
// Hook the NdrGetBuffer function and modify buffer onLeave if conditions match
    ...
    if (ndrGetBuffer !== null) {
        Interceptor.attach(ndrGetBuffer, {
            onEnter: function (args) {
                // Store pStubMsg for use in onLeave
                this.pStubMsg = args[0];
            },
            onLeave: function (retval) {
                try {
                    const pStubMsg = this.pStubMsg;
                    ...
                    send("[!] Error accessing or modifying buffer in NdrGetBuffer onLeave: " + error.message);
                }
            }
        });
    } else {
